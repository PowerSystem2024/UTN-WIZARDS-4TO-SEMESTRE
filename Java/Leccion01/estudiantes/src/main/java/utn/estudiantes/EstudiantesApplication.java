    ...
    private boolean ejecutarOpciones(Scanner consola){
        ...
        switch (opcion){
            ...
            case 2 -> { //Buscar estudiante por id
                ...
                if(estudiante != null) {
                    logger.info("Estudiante encontrado: " + estudiante + n1);
                } else {
                    logger.info("Estudiante NO encontrado: " + estudiante + n1);
                }
            }
            case 3 -> { //Agregar estudiante
                logger.info("Agregar estudiante: " + n1);
                logger.info("Nombre: ");
                ...
                logger.info("Estudiante agregado: " + estudiante + n1);
            }
            case 4 -> { // Modificar estudiante
                ...
                if (estudiante != null) {
                    ...
                    estudianteServicio.guardarEstudiante(estudiante);
                    logger.info("Estudiante modificado: " + estudiante + n1);
                } else
